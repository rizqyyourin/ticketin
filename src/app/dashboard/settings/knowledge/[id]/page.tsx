...
function NewArticleForm() {
  ...
  const handleSave = (publish: boolean) => {
    ...
    setSaved(true);
    setTimeout(() => {
      router.push("/dashboard/settings/knowledge");
    }, 800);
  };
  ...
  return (
    <div className="p-6 space-y-5 max-w-5xl mx-auto">
      <Breadcrumb
        items={[
          { label: "Knowledge Management", href: "/dashboard/settings/knowledge" },
          { label: "New Article" },
        ]}
      />
  ...
  if (!article) {
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <Link href="/dashboard/settings/knowledge" className="px-4 py-2 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary/90 transition-colors">
