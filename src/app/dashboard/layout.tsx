...
const sidebarItems = [
  ...
  { icon: ClipboardList, label: "Service Request", href: "/dashboard/service-request" },
  { icon: UserCog, label: "User Management", href: "/dashboard/user-management" },
  { icon: Users, label: "Contact", href: "/dashboard/contact" },
];

const settingsItems = [
  { icon: MessageCircleHeart, label: "CSAT Survey", href: "/dashboard/settings/csat" },
  { icon: BookOpen,           label: "Knowledge Management", href: "/dashboard/settings/knowledge" },
  { icon: Mail,               label: "Email Templates", href: "/dashboard/settings/email-templates" },
];
              ...
              <>
                ...
                >
                  <Settings className={`size-4 ${
                    pathname.startsWith("/dashboard/settings") ? "text-primary" : "text-zinc-400 group-hover:text-primary"
                  }`} />
                  <span className="flex-1 text-left">Settings</span>
                  <ChevronDown className={`size-3.5 transition-transform duration-200 ${
                    isSettingsOpen ? "rotate-180" : ""
                  } ${
                    pathname.startsWith("/dashboard/settings") ? "text-primary" : "text-zinc-400"
                  }`} />
                </button>
                {isSettingsOpen && (
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-zinc-200 dark:border-zinc-800 relative">
              <div className="text-right hidden md:block">
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Yourin Dev</p>
                <p className="text-[10px] font-medium text-zinc-400 uppercase tracking-widest">Administrator</p>
              </div>
              <button 
                onClick={(e) => {
                  e.stopPropagation();
